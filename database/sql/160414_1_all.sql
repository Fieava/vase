...
CREATE TABLE `models` (
  ...
  `model_time_can_be_exceed` int(1) DEFAULT NULL,
...
-- Records of models
-- ----------------------------
INSERT INTO `models` VALUES ('1', '1', '用户系统', null, null, '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('2', '1', '登录', null, '1', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('3', '1', '注册', null, '1', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('4', '1', '验证身份', null, '3', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('5', '1', '忘记密码', null, '1', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('6', '1', '邮箱找回密码', null, '5', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('7', '1', '发送邮件', null, '6', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('8', '1', '验证邮件验证码', null, '6', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('9', '1', '问题找回密码', null, '5', '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('10', '2', 'L1A', null, null, '1', null, null, null, null, null);
INSERT INTO `models` VALUES ('11', '2', 'L2A', null, '10', '1', null, null, null, null, null);
...
CREATE TABLE `projects` (
  ...
  `project_time_can_be_exceed` int(1) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Records of projects
-- ----------------------------
INSERT INTO `projects` VALUES ('1', 'Vase', 'Vase', '一个项目/任务跟踪计划系统', '1', null, null, '0.1', null, null, null);
INSERT INTO `projects` VALUES ('2', 'TEST', 'Test', 'Lalalalalala', '1', null, null, '1.0', null, null, null);
...
INSERT INTO `project_team` VALUES ('2', '2', '1');
...
-- Records of settings
-- ----------------------------
INSERT INTO `settings` VALUES ('1', 'page.wallpaper_date', '20160414');
INSERT INTO `settings` VALUES ('2', 'page.wallpaper_url', 'http://www.bing.com/az/hprichbg/rb/GareSaintLazare_ZH-CN6611772290_1920x1080.jpg');
INSERT INTO `settings` VALUES ('3', 'page.wallpaper_text', '法国，巴黎圣拉扎尔火车站 (© Hal Bergman/Getty Images)');
...
INSERT INTO `user_purview_executive` VALUES ('11', '1', 'SubNav.task', '1');
INSERT INTO `user_purview_executive` VALUES ('12', '1', 'Project.model', '1');
INSERT INTO `user_purview_executive` VALUES ('13', '1', 'Task.list_by_model', '1');
